...
InterruptVectorTable:
        ...
        dd      STGameOver ; Simptris Game Over  ; Int 0Bh (IRQ 3)
        dd      STNewPiece ; Simptris New Piece  ; Int 0Ch (IRQ 4)
        dd      STReceived ; Simptris Received   ; Int 0Dh (IRQ 5)
        dd      STTouchdown ; Simptris Touchdown  ; Int 0Eh (IRQ 6)
        dd      STClear ; Simptris Clear      ; Int 0Fh (IRQ 7)
        ; Software Interrupts:
...
STClear:
	...
	iret; Generated by c86 (BYU-NASM) 5.1 (beta) from ISRHandlers.i
	CPU	8086
	ALIGN	2
	jmp	main	; Jump to program start
	ALIGN	2
...
L_YAKkernel_109:
	...
	jmp	L_YAKkernel_110
L_YAKkernel_120:
	DB	"Overflow of Queue",0xA,0
L_YAKkernel_119:
	DB	" messages.",0xA,0
L_YAKkernel_118:
	DB	"Adding to queue with ",0
	ALIGN	2
YKQPost:
	; >>>>> Line:	524
...
L_YAKkernel_137:
	...
	mov	word [si], ax
	; >>>>> Line:	592
	; >>>>> if (!YKEventReadyToUnblock(event,eventMa 
	push	word [bp+6]
	push	word [bp-2]
...
L_YAKkernel_203:
	...
	add	sp, 2
	; >>>>> Line:	727
	; >>>>> printString("Suspended T 
	mov	ax, L_YAKkernel_200
	push	ax
	call	printString
	add	sp, 2
	; >>>>> Line:	728
